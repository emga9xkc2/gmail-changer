...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 831x399+256+174
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
set site_3_0 $top.m46
    ...
    $site_3_0.men56 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label GUIDE 
    $site_3_0.men56 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {UPDATE NEW VERSION} 
    $site_3_0.men56 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {OPEN FOLDER TOOL} 
    $site_3_0.men56 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {OPEN HCONFIG} 
