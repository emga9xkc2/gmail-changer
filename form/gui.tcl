...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 835x339+243+178
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
set site_4_0 $site_3_0.men47
    $site_3_0.men47 add cascade \
        -menu "$site_3_0.men47.men48" -command {{}} -label {RESTORE DISABLE} 
    menu $site_4_0.men48 \
        -activebackground $vTcl(actual_gui_menu_analog) -activeforeground red \
        -background $vTcl(actual_gui_menu_bg) -font TkMenuFont \
        -foreground $vTcl(actual_gui_menu_fg) -tearoff 0 
    ...
    $site_3_0.men47 add command \
        -command {#} -label {EMAIL RECOVERY (LIST)} 
    $site_3_0.men47 add command \
        -command {#} -label {API KEY CAPTCHA (1 KEY)} 
    
set site_4_0 $site_3_0.men47
    $site_3_0.men47 add cascade \
        -menu "$site_3_0.men47.men49" -command {{}} -label PROXY 
    menu $site_4_0.men49 \
        -activebackground $vTcl(actual_gui_menu_analog) -activeforeground red \
        -background $vTcl(actual_gui_menu_bg) -font TkMenuFont \
        -foreground $vTcl(actual_gui_menu_fg) -tearoff 0 
    $site_4_0.men49 add command \
        ...
        -font {} -foreground {} -label {CYBER GHOST (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {VYPR (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {TMPROXY (1 KEY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {LIST PROXY (LIST IP:PORT)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {IPVANISH (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {EXPRESS (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {DCOM (NAME)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {SSH (LIST IP|USER|PASS)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {HMA NEW (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {911 (LIST COUNTRY)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {PIA S5 (URL API)} 
    $site_4_0.men49 add command \
        -activebackground {} -activeforeground {} -background {} -command {#} \
        -font {} -foreground {} -label {OBCPROXY (1 PROXY)} 
    $site_3_0.men47 add command \
        -command {#} -label {PASSWORD (LIST)} 
    $site_3_0.men47 add command \
        -command {#} -label {EMAIL RECOVERY DOMAIN (1 DOMAIN)} 
    $site_3_0.men47 add command \
        -command {#} -label {PASSWORD KEY (1 KEY)} 
    $site_3_0.men47 add command \
        -command {#} -label {KEY ACTIVE} 
    $site_3_0.men47 add command \
        -command {#} -label {VERIFY PHONE} 
    $site_3_0.men47 add command \
        -command {#} -label {USER AGENT (LIST)} 
...
set site_3_0 $top.m46
    ...
    checkbutton $top.che71 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {Verify youtube} -variable checkVerifyyoutube 
    vTcl:DefineAlias "$top.che71" "Checkbutton1_1_1_1" vTcl:WidgetProc "Toplevel1" 1
    bind $top.che71 <<SetBalloon>> {
        set ::vTcl::balloon::%W {Verify youtube}
    }
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.tSp54 \
        ...
        -height 0 -relheight 0.048 -anchor nw -bordermode ignore 
    place $top.tex58 \
        -in $top -x 0 -relx 0.012 -y 0 -rely 0.501 -width 0 -relwidth 0.957 \
        -height 0 -relheight 0.334 -anchor nw -bordermode ignore 
    place $top.lab59 \
    ...
    place $top.tSp51 \
        ...
        -height 0 -relheight 0.048 -anchor nw -bordermode ignore 
    place $top.che71 \
        -in $top -x 0 -relx 0.468 -y 0 -rely 0.1 -width 0 -relwidth 0.168 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
